...
if ((Get-Item ".\exm.ps1" -ErrorAction SilentlyContinue).IsReadOnly) {
    Remove-Item ".\exm.ps1" -Force
}
...
Update-Progress -Activity "Validating" -StatusMessage "Checking exm.ps1 Syntax" -Percent 0
try {
    Get-Command -Syntax .\exm.ps1 | Out-Null
} catch {
    Write-Warning "Syntax Validation for 'exm.ps1' has failed"
