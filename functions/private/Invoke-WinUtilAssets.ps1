...
"@
          ...
          $LogoPath1.Fill = [System.Windows.Media.BrushConverter]::new().ConvertFromString("#cb404d")
...
"@
          ...
          $LogoPath2.Fill = [System.Windows.Media.BrushConverter]::new().ConvertFromString("#cb404d")
...
"@
          ...
          $LogoPath3.Fill = [System.Windows.Media.BrushConverter]::new().ConvertFromString("#6e6e6e")
